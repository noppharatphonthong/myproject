...
import { Datacheckmoney } from '../../models/datacheckmoney';
import { Observable } from 'rxjs/Observable';

/*
  Generated class for the CheckMoneyServiceProvider provider.

  See https://angular.io/docs/ts/latest/guide/dependency-injection.html
  for more info on providers and Angular DI.
*/
@Injectable()
export class CheckMoneyServiceProvider {
  
  constructor(public http: Http,
    public ipv4ServiceProvider: Ipv4ServiceProvider) {}

public getOrder():  Observable<Datacheckmoney> 
{  
...
return this.http.post('http://'+ipv4+'/backend/datacheckmoney.php',data, { headers: myHeader })
.map((res: Response) => 
{
